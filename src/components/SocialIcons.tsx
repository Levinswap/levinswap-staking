...
const SocialIcons = () => {
    ...
    const onPressTwitter = useLinker("https://twitter.com/levinswap", "", "_blank");
    const onPressGithub = useLinker("https://github.com/levinswap", "", "_blank");
    const onPressDiscord = useLinker("https://discord.gg/vYHCcJQFPW", "", "_blank");
    return (
